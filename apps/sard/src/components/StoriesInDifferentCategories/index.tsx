...
export default function StoriesInDifferentCategory({
  storyId,
  categoryName,
  onStoryClick,
}: {
  ...
  const {
    ...
    {
      id: storyId,
      categories: categoies as string[],
      limit: 3,
  ...
  return (
    <div className="flex w-full flex-col">
      <p className="text-3xl">{messages.format("differentStories")}</p>
